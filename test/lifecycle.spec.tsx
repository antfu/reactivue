...
const onMountedJestFn = vi.fn()
const onBeforeMountJestFn = vi.fn()
const onUnmountedJestFn = vi.fn()
const onUpdatedJestFn = vi.fn()
const onBeforeUnmountJestFn = vi.fn()
const onBeforeUpdateJestFn = vi.fn()
